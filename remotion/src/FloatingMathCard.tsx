  ...
  return (
    <motion.div
      ...
      style={{
        ...
        width: box.width,
        maxWidth: '100%',
        // CHANGED: was a forced `height: box.height` that left large empty
        // space below short content. Now the card grows to fit its content
        // and is only capped by `maxHeight` so it can never blow past the
        // cards zone.
        height: 'auto',
